...
let TestingController = class TestingController {
    ...
    async addProduct(name, occupation, age) {
        const generatedId = await this.testingService.insertUser(name, occupation, age);
    }
    ...
    updateUser(id, name, occupation, age) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('occupation')),
    __param(2, (0, common_1.Body)('age')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, Number]),
    __metadata("design:returntype", Promise)
], TestingController.prototype, "addProduct", null);
__decorate([
    (0, common_1.Get)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TestingController.prototype, "getAllProducts", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], TestingController.prototype, "getProduct", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)('name')),
    __param(2, (0, common_1.Body)('occupation')),
    __param(3, (0, common_1.Body)('age')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, Number]),
    __metadata("design:returntype", void 0)
], TestingController.prototype, "updateUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TestingController.prototype, "removeProduct", null);
